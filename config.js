...
const ALIVE = process.env.ALIVE || "*`GOD  | SETH`* Online 🤍";
const HANDLERS = process.env.HANDLER || ",";
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:de6a8074a3c1403b85943924175a73f7";
const SUDO = process.env.SUDO || '94776860011';
...
const BOT_INFO = process.env.BOT_INFO || "X-BOT-MD;GOD  | SETH;https://i.imgur.com/r3GZeiX.jpeg";
const URL = process.env.URL || "https://www.instagram.com/sparky.drip";
const AUDIO_DATA = process.env.AUDIO_DATA || "X BOT MD;GOD  | SETH;https://i.imgur.com/fVCRCYG.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "X BOT MD;GOD  | SETH";
